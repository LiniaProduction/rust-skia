...
export EMCC_CFLAGS="$PORT $THREADS -sERROR_ON_UNDEFINED_SYMBOLS=0 -sMODULARIZE=1 -sEXPORT_ES6=1 -sEXPORT_NAME=createModule -sEXPORT_ALL=1 -sEXPORTED_RUNTIME_METHODS=WebGPU,GL,HEAPU8 -sMAX_WEBGL_VERSION=2 -sWASM_BIGINT=1 -sSTACK_SIZE=5MB -sALLOW_MEMORY_GROWTH=1 -sINITIAL_MEMORY=256MB -sMAXIMUM_MEMORY=4GB -sPTHREAD_POOL_SIZE=1 -sSUPPORT_LONGJMP=wasm -sDISABLE_EXCEPTION_CATCHING=1 -sDISABLE_EXCEPTION_THROWING=1 -fno-exceptions"
